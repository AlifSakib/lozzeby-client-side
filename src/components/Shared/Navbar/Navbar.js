      ...
      <div className="relative flex items-center justify-between">
        <div className="flex items-center">
          <Link
            ...
            aria-label="LozzeBy"
            title="LozzeBy"
            className="inline-flex items-center mr-8  text-teal-600"
          >
            <svg
            ...
            <span className="ml-2 text-2xl font-bold tracking-wide text-teal-800 underline-offset-4 underline">
              LozzeBy
            </span>
          </Link>
          ...
          {user?.uid ? (
            ...
            <>
              ...
              <li>
                <Link
                  to="/user-register"
                  className="inline-flex items-center justify-center h-10 px-6  tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none font-bold"
                  aria-label="Register"
                  title="Register"
                >
                  Register
